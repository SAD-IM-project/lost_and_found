...
export default function Content() {
    return (<div className="flex flex-row items-start p-5 w-full h-screen flex-wrap z-0">
        <div className="flex w-full h-1/2">
            <div className="w-1/2 h-1/3 px-2 flex flex-col items-center justify-center ">
                <div className="w-full h-full relative ">
                    <AspectRatio ratio={1 / 1}>
                        <Image
                            ...
                            alt="Hero Image"
                            fill={true}
                            className="rounded-md object-contain z-0"
                        />
                    </AspectRatio>
                </div>
            </div>
