...
export const onclick_api = {
    'createCityDistrict': {api: 'api/db/add_city_district', method: 'POST', params: ['city', 'district']},
    'createCategory': {api: 'api/category/create', method: 'POST', params: ['category_name', 'sub_of']},
    'deleteCategory': {api: 'api/category/delete', method: 'DELETE', params: ['category_name']},
}